            ...
            <div class="container">
                ...
                <div class="room-grids">
                    <?php
								...
								?>
                    <div class="room1">
                        <div class="col-md-5 room-grid" style="padding-bottom: 20px">
                            <a href="#" class="mask">
                                <img src="admin/images/<?php echo $row->Image;?>" class=" mask img-responsive zoom-img"
                                    alt="" /></a>
                        </div>
                        <div class="col-md-7 room-grid1">
                            <p style="font-weight: bold;">Tên Phòng: <?php  echo htmlentities($row->RoomName);?></p>
                            <h4> <?php  echo htmlentities($row->FacilityTitle);?> </h4>
                            <p><?php  echo htmlentities($row->RoomDesc);?></p>
                            <p>Người Lớn: <?php  echo htmlentities($row->MaxAdult);?></p>
                            <p>Trẻ Em: <?php  echo htmlentities($row->MaxChild);?></p>
                            <p>Số Giường: <?php  echo htmlentities($row->NoofBed);?></p>
                            <p>Room Facilities: <?php  echo htmlentities($row->RoomFacility);?></p>
                            <p>Giá: <?php  echo number_format($row->Price)?> VND</p>
                            <button class="btn btn-success"><a href="book-room.php?rmid=<?php echo $row->rmid;?>">Đặt
                                    Phòng</a></button>
                                    </br>
                                    </br>
                                    </br>
