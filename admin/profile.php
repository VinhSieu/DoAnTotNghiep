...
{               ?>
                                            <form method="post">
                                                <div class="form-group"> <label for="exampleInputEmail1">Tên Quản Trị
                                                        viên</label> <input type="text" class="form-control"
                                                        name="adminname" value="<?php  echo $row->AdminName;?>"
                                                        required='true'> </div>
                                                <div class="form-group"> <label for="exampleInputEmail1">Tên Tài
                                                ...
                                                <div class="form-group"> <label for="exampleInputEmail1">Ngày Đăng Ký
                                                        Tài Khoản</label> <input type="text" class="form-control"
                                                        id="email2" name="" value="<?php  echo $row->AdminRegdate;?>"
                                                        readonly="true"> </div>
                                                <?php $cnt=$cnt+1;}} ?>

                                                <button type="submit" class="btn btn-default" name="submit">Đồng
                                                    Ý</button>
                                            </form>
                                        </div>
                                    </div>
