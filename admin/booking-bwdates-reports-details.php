                                ...
                                <div class="forms">
                                    <div class="form-grids widget-shadow" data-example-id="basic-forms">
                                        <div class="form-title">
                                            <h4>Tra Cứu Thông Tin Đặt Phòng</h4>
                                        </div>
                                            ...
                                            <table
                                                ...
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th class="d-none d-sm-table-cell">Ngày Đặt Phòng</th>
...
{               ?>
                                                    <tr>
                                                        ...
                                                        <td class="font-w600">
                                                            <?php  echo htmlentities($row->BookingNumber);?></td>
                                                        <td class="font-w600">
                                                        ...
                                                        <td class="font-w600"><?php echo "Chưa Cập Nhật"; ?></td>
                                                        <?php } else { ?>
                                                        <td class="d-none d-sm-table-cell">
                                                            <span
                                                        ...
                                                        <td class="d-none d-sm-table-cell"><a
                                                                href="view-booking-detail.php?bookingid=<?php echo htmlentities ($row->BookingNumber);?>"><i
