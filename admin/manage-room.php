                                            ...
                                            <table
                                                ...
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th class="d-none d-sm-table-cell">Ngày Lập</th>
...
{               ?>
                                                    <tr>
                                                        ...
                                                        <td class="font-w600">
                                                            <?php  echo htmlentities($row->RoomName);?></td>
                                                        <td class="d-none d-sm-table-cell">
                                                            <?php  echo htmlentities($row->RoomDesc);?></td>
                                                        ...
                                                        <td class="d-none d-sm-table-cell"><a
                                                                href="edit-room.php?editid=<?php echo ($row->ID);?>">Chỉnh
                                                                Sửa</a></td>
                                                        <td class="d-none d-sm-table-cell"><a href="manage-room.php?delid=<?php echo ($row->ID);?>" onclick="return confirm('Do you really want to Delete ?');">Delete</a></td>
