						...
						<div class="forms">
							<div class="form-grids widget-shadow" data-example-id="basic-forms"> 
								<div class="form-title">
									<h4>Lịch Sử Hỗ Trợ</h4>
								</div>
								 <form id="basic-form" method="post">
                                <div class="form-group" style="padding-top: 20px">
                                    <label style="font-size: 20px;padding-bottom: 10px">Lịch Sử Hỗ Trợ</label>
                                    <input id="searchdata" type="text" name="searchdata" required="true" class="form-control" placeholder="Enter Your Mobile Number"></div>
                                
                                <br>
                                <button type="submit" class="btn btn-primary" name="search" id="submit">Tìm</button>
                            </form>
								<div class="form-body">
								 <?php
