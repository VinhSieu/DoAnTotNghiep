                                ...
                                <div class="forms">
                                    <div class="form-grids widget-shadow" data-example-id="basic-forms">
                                        <div class="form-title">
                                            <h4>Tra Cứu Ngày Gửi Yêu Cầu Hỗ Trợ</h4>
                                        </div>
                                            ...
                                            <table
                                                ...
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th class="d-none d-sm-table-cell">Ngày Gửi Hỗ Trợ</th>
...
{               ?>
                                                    <tr>
                                                        ...
                                                        <td class="font-w600"><?php  echo htmlentities($row->Name);?>
                                                        </td>
                                                        <td class="d-none d-sm-table-cell">
                                                            <?php  echo htmlentities($row->Email);?></td>
                                                        <td class="d-none d-sm-table-cell">
                                                            <?php  echo htmlentities($row->MobileNumber);?></td>

                                                        <td class="d-none d-sm-table-cell">
                                                            <span
                                                                class="badge badge-primary"><?php  echo htmlentities($row->EnquiryDate);?></span>
                                                        </td>
                                                        <td><a
                                                                href="view-enquiry.php?viewid=<?php echo htmlentities ($row->ID);?>">View
                                                                Details</a></td>
                                                    </tr>
