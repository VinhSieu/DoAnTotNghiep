                            ...
                            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12" style="margin-bottom:1px;">
                                <div class="content-top-1">
                                    <h4 class="text-left text-uppercase" style="color: red"><a
                                            href="approved-booking.php"><b>Đặt Phòng Được Chấp Thuận</b></a></h4>
                                    <div class="row vertical-center-box vertical-center-box-tablet">
                                        <?php 
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                <div class="content-top-1">
                                    <h4 class="text-left text-uppercase" style="color: magenta"><a
                                            href="cancelled-booking.php"><b>Đặt Phòng Đã Hủy</b></a></h4>
                                    <div class="row vertical-center-box vertical-center-box-tablet">
                                        <?php 
                    ...
                    <div class="col-md-12" style="padding-top: 20px">
                        <div class="row">
                            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                <div class="content-top-1">
                                    <h4 class="text-left text-uppercase" style="color: orange"><a
                                            href="reg-users.php"><b>Tài Khoản Khách Hàng</b></a></h4>
                                    <div class="row vertical-center-box vertical-center-box-tablet">
                                        <?php 
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12" style="margin-bottom:1px;">
                                <div class="content-top-1">
                                    <h4 class="text-left text-uppercase" style="color: red"><a
                                            href="read-enquiry.php"><b>Đọc Hỗ Trợ</b></a></h4>
                                    <div class="row vertical-center-box vertical-center-box-tablet">
                                        <?php 
                                        ...
                                        <div class="col-xs-9 cus-gh-hd-pro">
                                            <h2 class="text-right no-margin"><?php echo htmlentities($totreadqueries);?>
                                            </h2>
                                        </div>
                                    </div>
                                    <div class="progress progress-mini">
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                <div class="content-top-1">
                                    <h4 class="text-left text-uppercase" style="color: magenta"><a
                                            href="unread-enquiry.php"><b>Chưa Đọc Hỗ Trợ</b></a></h4>
                                    <div class="row vertical-center-box vertical-center-box-tablet">
                                        <?php 
