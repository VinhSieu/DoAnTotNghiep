...
<body>
    ...
    if ($query->rowCount() > 0) {
        foreach ($results as $row) {
                                                ?>
                                                <div class="form-group"> <label for="exampleInputEmail1">Tiêu Đề Giới
                                                        Thiệu</label> <input type="text" name="pagetitle" id="pagetitle"
                                                        required="true" value="<?php echo $row->PageTitle; ?>"
                                                        class="form-control"> </div>
                                                <div class="form-group"> <label for="exampleInputEmail1">Mô Tả Giới
                                                        Thiệu</label> <textarea type="text" name="pagedes" id="pagedes"
                                                        required="true"
