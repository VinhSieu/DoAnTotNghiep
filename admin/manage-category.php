                                            ...
                                            <table
                                                ...
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th>Loại Phòng</th>
                                                        <th class="d-none d-sm-table-cell">Mô Tả Loại Phòng</th>
...
{               ?>
                                                    <tr>
                                                        ...
                                                        <td class="font-w600">
                                                            <?php  echo htmlentities($row->CategoryName);?></td>
                                                        <td class="d-none d-sm-table-cell">
                                                            <?php  echo htmlentities($row->Description);?></td>
                                                        <td class="d-none d-sm-table-cell">
                                                            <span
                                                                class="badge badge-primary"><?php  echo htmlentities($row->Date);?></span>
                                                        </td>
