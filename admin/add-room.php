                                    ...
                                    <div class="form-grids widget-shadow" data-example-id="basic-forms">
                                        ...
                                        <div class="form-body">
                                            ...
                                            <form method="post" enctype="multipart/form-data">
                                                <div class="form-group"> <label for="exampleInputEmail1">Loại
                                                        Phòng</label> <select type="text" name="roomtype" id="roomtype"
...
{          
    ?>
                                                ...
                                                <div class="form-group"> <label for="exampleInputEmail1">Tên
                                                        Phòng</label> <input type="text" class="form-control"
                                                        name="roomname" value="" required='true'> </div>
                                                <div class="form-group"> <label for="exampleInputEmail1">Người
                                                        Lớn</label> <input type="text" class="form-control"
                                                        name="maxadult" value="" required='true'> </div>
                                                <div class="form-group"> <label for="exampleInputEmail1">Trẻ Em</label>
                                                    <input type="text" class="form-control" name="maxchild" value=""
                                                        required='true'> </div>
                                                <div class="form-group"> <label for="exampleInputEmail1">Mô Tả
                                                        Phòng</label> <textarea type="text" class="form-control"
                                                        name="roomdes" value=""></textarea> </div>
                                                <div class="form-group"> <label for="exampleInputEmail1">Số
                                                        Giường</label> <input type="text" class="form-control"
                                                        name="nobed" value="" required='true'> </div>
                                                <div class="form-group"> <label for="exampleInputEmail1">Ảnh</label>
...
{          
    ?>
                                                        <option value="<?php echo htmlentities($row->FacilityTitle);?>">
                                                            <?php echo htmlentities($row->FacilityTitle);?></option>
                                                        <?php } ?>
