                    ...
                    <div class="col-md-6 contact-right">
                        <form method="post">
                            ...
                            <?php
								...
								?>
                            <h5>Họ Tên</h5>
                            <input type="text" value="<?php  echo $row->FullName;?>" name="name" class="form-control"
                                required="true" readonly="true">
                            <h5>Số Điện Thoại</h5>
                            <input type="text" name="phone" class="form-control" required="true" maxlength="10"
                            ...
                            <input type="email" value="<?php  echo $row->Email;?>" class="form-control" name="email"
                                required="true" readonly="true"><?php $cnt=$cnt+1;}} ?>
                            <h5>ID Type</h5>
                            <select type="text" value="" class="form-control" name="idtype" required="true"
                                class="form-control">
                                <option value="">Choose ID Type</option>
                                <option value="Voter Card">Căn Cước Công Dân</option>
                                <option value="Driving Licence Card">Thẻ Hộ Chiếu</option>
                                <option value="Passport">Passport</option>
                            </select>
                            <h5>Giới Tính</h5>
                            <p style="text-align: left;"> <input type="radio" name="gender" id="gender" value="Female"
                                    checked="true">Nữ</p>
